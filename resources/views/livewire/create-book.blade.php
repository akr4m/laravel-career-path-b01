     ...
     <div class="p-6 text-gray-800">
         <form wire:submit="createBook" class="flex items-start space-x-3">
             <div class="grow">
                 ...
                 <input type="text" wire:model.live="title" id="title" class="w-full border border-gray-300 rounded-lg" />
                 @error('title') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
             </div>
             <div class="grow">
                 <label for="author">Book Author</label>
                 <input type="text" wire:model.live="author" id="author" class="w-full border border-gray-300 rounded-lg" />
